        ...
        <div className='todoPage'>
            <nav className='sidebar'>
                <ul className='sidebarOptions'>
                    ...
                    <li className='option gallery-tab' onClick={() => navigate("/gallery")}>Gallery
                        <div className="navbarBorder"><FontAwesomeIcon icon={faChevronRight} /></div></li>
                    <li className='option todo-tab active' onClick={() => navigate("/todo")}>ToDo
                        <div className="navbarBorder"><FontAwesomeIcon icon={faChevronRight} /></div></li>
                </ul>
            </nav>
            ...
            <main className='todo'>
                ...
                <section className='postsDetails'>
                    <h1 className='todo coming-soon' style={{ textAlign: "center", fontSize: "6rem", marginTop: "11rem", color: "lightgray" }}>Coming Soon</h1>
                </section>
            </main>
        </div>
    )
