        ...
        <div className='galleryPage'>
            <nav className='sidebar'>
                <ul className='sidebarOptions'>
                    ...
                    <li className='option gallery-tab active' onClick={() => navigate("/gallery")}>Gallery
                        <div className="navbarBorder"><FontAwesomeIcon icon={faChevronRight} /></div></li>
            ...
            <main className='gallery'>
                ...
                <section className='galleryDetails'>
                    <h1 className='gallery coming-soon' style={{ textAlign: "center", fontSize: "6rem", marginTop: "11rem", color: "lightgray" }}>Coming Soon</h1>
                </section>
            </main>
        </div>
    )
